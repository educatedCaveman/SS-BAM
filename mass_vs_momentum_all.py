...
fig, ax = plt.subplots()
ax.scatter(np_A_mass_gn, np_A_calc_momentum, label='Band A')
ax.scatter(np_B_mass_gn, np_B_calc_momentum, label='Band B')
ax.scatter(np_C_mass_gn, np_C_calc_momentum, label='Band C')
ax.scatter(np_D_mass_gn, np_D_calc_momentum, label='Band D')
ax.scatter(np_E_mass_gn, np_E_calc_momentum, label='Band E')
ax.scatter(np_F_mass_gn, np_F_calc_momentum, label='Band F')
